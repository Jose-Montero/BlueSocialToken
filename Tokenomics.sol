...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x.....; // Needs Wallet Address
...
contract BlueSocialToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x.....; //Needs Wallet Address
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18; // Change Token Amount
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Blue Social Token";
    string private _symbol = "BST";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; // Change Taxfee Amount
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 10; // Change Development Amount
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 50; // Change Liquidity Amount
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**18; // Change the Numbers as needed
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**18; // Change the Numbers as needed
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x........); //Needs Wallet Address
